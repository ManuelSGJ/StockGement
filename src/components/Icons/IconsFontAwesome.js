...
export const FaMagnifyingGlass  = <FontAwesomeIcon icon={faMagnifyingGlass} />
export const FaXmark  = <FontAwesomeIcon icon={faXmark} />
export const FaPenToSquare  = <FontAwesomeIcon icon={faPenToSquare} />
export const FaTrash  = <FontAwesomeIcon icon={faTrash} />
